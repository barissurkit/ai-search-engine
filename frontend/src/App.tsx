...
function App() {
  ...
  return (
    <div className="workspace-shell">
      <ConversationSidebar conversations={conversations} activeId={active?.id} onNew={returnToLanding} onOpen={(id) => navigate(`/c/${id}`)} onDelete={async (id) => { if (await remove(id) && route === id) returnToLanding() }} collapsed={collapsed} onToggle={toggle} themePreference={preference} onThemeChange={setPreference} />
